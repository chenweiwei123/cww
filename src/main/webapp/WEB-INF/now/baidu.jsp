	...
	<div id=wrapper>
			...
			<div class=head_wrapper>
					...
					<div class=s_form_wrapper>
						...
						<form id=form name=f action=//www.baidu.com/s class=fm>
							...
							<input type=hidden name=rsv_idx value=1> <input
								...
								value maxlength=255 autocomplete=off autofocus></span><span
				...
				<div id=u1>
					<a href=http://news.baidu.com name=tj_trnews class=mnav>新闻</a> <a
						href=http://www.hao123.com name=tj_trhao123 class=mnav>hao123</a>
					...
					<script>
						document
								.write('<a href="http://www.baidu.com/bdorz/login.gif?login&tpl=mn&u='
		...
		<div id=ftCon>
			<div id=ftConw>
				...
				<p id=cp>
					&copy;2017&nbsp;Baidu&nbsp;<a href=http://www.baidu.com/duty />使用百度前必读</a>&nbsp;
